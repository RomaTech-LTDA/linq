...
# ---------------------------------------------------------------------------
# publish.sh — Build verification and npm publish for @romatech/linq
# ---------------------------------------------------------------------------
# Usage:
...
echo "============================================"
echo " @romatech/linq — publish pipeline"
echo "============================================"
echo ""
...
# 7. Publish
echo "[6/6] Publishing @romatech/linq@$NEW_VERSION to npm..."
npm publish --access public
echo ""

echo "============================================"
echo " Published @romatech/linq@$NEW_VERSION"
echo "============================================"
